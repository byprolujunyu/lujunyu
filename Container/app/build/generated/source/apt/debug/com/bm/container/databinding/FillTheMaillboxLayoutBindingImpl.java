...
public class FillTheMaillboxLayoutBindingImpl extends FillTheMaillboxLayoutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_chest, 3);
        sViewsWithIds.put(R.id.add_chest, 4);
        sViewsWithIds.put(R.id.list_chest, 5);
        sViewsWithIds.put(R.id.ll_button, 6);
        sViewsWithIds.put(R.id.tvSubmit, 7);
    }
    // views
    @NonNull
    ...
    public FillTheMaillboxLayoutBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FillTheMaillboxLayoutBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
