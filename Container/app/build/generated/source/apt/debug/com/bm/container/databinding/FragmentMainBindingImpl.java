...
public class FragmentMainBindingImpl extends FragmentMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_iamgetop, 4);
        sViewsWithIds.put(R.id.i_want_to_buy, 5);
        sViewsWithIds.put(R.id.i_want_to_sale, 6);
        sViewsWithIds.put(R.id.imageView, 7);
        sViewsWithIds.put(R.id.list_buy, 8);
        sViewsWithIds.put(R.id.list_sale, 9);
    }
    // views
    @NonNull
    ...
    private FragmentMainBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.bm.container.view.ListViewForScrollView) bindings[8]
