...
import com.bm.container.databinding.DialogChooseStatusBinding;
...
public class ChooseStatusDialog extends Dialog {
    ...
    public ChooseStatusDialog(Context context, int theme) {
        super(context, theme);
        this.context = context;
    }
    ...
    public static class Builder {
        private Context context;
        private DialogChooseStatusBinding binding;
        ...
        public ChooseStatusDialog create() {
            final ChooseStatusDialog dialog = new ChooseStatusDialog(context, R.style.AlertDialog);
            binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.dialog_choose_status, null, false);
