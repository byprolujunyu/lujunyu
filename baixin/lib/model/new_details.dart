class NewDetailModel {
  String code;
  String message;
  NewDetailModel_Data data;

  NewDetailModel({this.code, this.message, this.data});

  NewDetailModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new NewDetailModel_Data.fromJson(json['data']) : null;
  }
...
class NewDetailModel_Data {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  NewDetailModel_Data({this.goodInfo, this.goodComments, this.advertesPicture});

  NewDetailModel_Data.fromJson(Map<String, dynamic> json) {
