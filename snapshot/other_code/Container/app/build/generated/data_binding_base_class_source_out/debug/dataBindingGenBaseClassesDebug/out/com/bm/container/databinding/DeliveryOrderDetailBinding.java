...
public abstract class DeliveryOrderDetailBinding extends ViewDataBinding {
  ...
  protected DeliveryOrderDetailBinding(DataBindingComponent _bindingComponent, View _root,
      ...
      LinearLayout invoiceModel, TextView leftButton, TextView location, LinearLayout modelButton,
      TextView name, TextView num, TextView orderId, TextView payType, LinearLayout person,
      EasyRoundImageView pic, RadioButton rbDanWei, RadioButton rbGeTi, SwipeRefreshLayout refresh,
      TextView rightButton, TextView state, TextView tip, TextView tipTop, TextView title,
      TopbarBinding topbar, TextView tvAdd, TextView tvBankIdText, TextView tvBankName,
      TextView tvDeliveryTime, TextView tvHintIsShow, TextView tvInvoicePhone, TextView tvOrderTime,
      TextView tvPayTime, TextView tvTitleName, View viewBackground) {
  ...
  @NonNull
  public static DeliveryOrderDetailBinding inflate(@NonNull LayoutInflater inflater,
  ...
  public static DeliveryOrderDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<DeliveryOrderDetailBinding>inflate(inflater, com.bm.container.R.layout.delivery_order_detail, root, attachToRoot, component);
  }
  ...
  public static DeliveryOrderDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<DeliveryOrderDetailBinding>inflate(inflater, com.bm.container.R.layout.delivery_order_detail, null, false, component);
  }
  ...
  public static DeliveryOrderDetailBinding bind(@NonNull View view,
      @Nullable DataBindingComponent component) {
    return (DeliveryOrderDetailBinding)bind(component, view, com.bm.container.R.layout.delivery_order_detail);
  }
}
