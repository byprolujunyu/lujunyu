...
public class ActivityChangePwdBindingImpl extends ActivityChangePwdBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.old, 3);
        sViewsWithIds.put(R.id.pwd1, 4);
        sViewsWithIds.put(R.id.pwd2, 5);
        sViewsWithIds.put(R.id.code, 6);
        sViewsWithIds.put(R.id.code_btn, 7);
    ...
    public ActivityChangePwdBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private ActivityChangePwdBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
