...
public class ActivityPayBindingImpl extends ActivityPayBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvPayPrice, 3);
        sViewsWithIds.put(R.id.pay_model, 4);
        sViewsWithIds.put(R.id.change_pwd, 5);
        sViewsWithIds.put(R.id.weixin, 6);
        sViewsWithIds.put(R.id.introduction, 7);
        sViewsWithIds.put(R.id.alipay, 8);
        sViewsWithIds.put(R.id.hotline, 9);
        sViewsWithIds.put(R.id.pay, 10);
    }
    // views
    @NonNull
    ...
    public ActivityPayBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private ActivityPayBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.bm.container.view.MultipleRadioGroup) bindings[4]
