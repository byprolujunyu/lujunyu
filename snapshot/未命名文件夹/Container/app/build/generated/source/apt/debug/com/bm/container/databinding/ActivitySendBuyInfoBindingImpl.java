...
public class ActivitySendBuyInfoBindingImpl extends ActivitySendBuyInfoBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.countryText, 4);
        ...
        sViewsWithIds.put(R.id.time, 16);
        sViewsWithIds.put(R.id.time_text, 17);
        sViewsWithIds.put(R.id.special, 18);
        sViewsWithIds.put(R.id.sure, 19);
    }
    // views
    @NonNull
    ...
    public ActivitySendBuyInfoBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 20, sIncludes, sViewsWithIds));
    }
    private ActivitySendBuyInfoBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
