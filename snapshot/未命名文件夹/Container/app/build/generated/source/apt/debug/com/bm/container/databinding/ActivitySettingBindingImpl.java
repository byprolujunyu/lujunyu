...
public class ActivitySettingBindingImpl extends ActivitySettingBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.change_pwd, 3);
        sViewsWithIds.put(R.id.introduction, 4);
        sViewsWithIds.put(R.id.hotline, 5);
        sViewsWithIds.put(R.id.phone, 6);
        sViewsWithIds.put(R.id.llAgreement, 7);
        sViewsWithIds.put(R.id.llUsage, 8);
        sViewsWithIds.put(R.id.etOfficialAccounts, 9);
        sViewsWithIds.put(R.id.exit, 10);
    }
    // views
    @NonNull
