...
public class DeliveryOrderDetailBindingImpl extends DeliveryOrderDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvTitleName, 7);
        ...
        sViewsWithIds.put(R.id.tvHintIsShow, 12);
    ...
    public DeliveryOrderDetailBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 37, sIncludes, sViewsWithIds));
    }
    private DeliveryOrderDetailBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
