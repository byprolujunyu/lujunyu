...
/**
 * Created by kec on 2017/6/19.
 */

public class MyWaveSideBar extends View {
     ...
     */
    private WaveSideBar.OnSelectIndexItemListener onSelectIndexItemListener;
    ...
    public MyWaveSideBar(Context context) {
        this(context, null);
    }

    public MyWaveSideBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyWaveSideBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnSelectIndexItemListener(WaveSideBar.OnSelectIndexItemListener onSelectIndexItemListener) {
